...
const RecipeDetailPage: React.FC = () => {
  ...
  console.log("RD", recipeDetails);
  console.log("ING", recipeDetails?.totalNutrients.WATER.label);
  ...
  return (
    <Container>
     {loading ? <NothingToDisplay/> :  <Wrapper>
        <TopDiv>
          <TopLeftDiv>
              ...
              {recipeDetails && (
                <NutriDivOne>
                  <span>
                    ...
                    {recipeDetails.dietLabels.length === 0 && <span>None</span>}{" "}
                  </span>
